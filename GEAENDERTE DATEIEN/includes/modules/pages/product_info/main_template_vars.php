...
// This should be first line of the script:
    ...
    if ($product_not_found) {
        ...
        $manufacturers_gpsr_postcode = zen_get_products_manufacturers_gpsr_postcode((int)$_GET['products_id']);
        $manufacturers_gpsr_city = zen_get_products_manufacturers_gpsr_city((int)$_GET['products_id']);
        $manufacturers_gpsr_country = zen_get_products_manufacturers_gpsr_country((int)$_GET['products_id']);
        $manufacturers_gpsr_url = zen_get_products_manufacturers_gpsr_url((int)$_GET['products_id']);
        $manufacturers_gpsr_company_noneu = zen_get_products_manufacturers_gpsr_company_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_contact_person_noneu = zen_get_products_manufacturers_gpsr_contact_person_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_street_noneu = zen_get_products_manufacturers_gpsr_street_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_postcode_noneu = zen_get_products_manufacturers_gpsr_postcode_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_city_noneu = zen_get_products_manufacturers_gpsr_city_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_country_noneu = zen_get_products_manufacturers_gpsr_country_noneu((int)$_GET['products_id']);
        $manufacturers_gpsr_url_noneu = zen_get_products_manufacturers_gpsr_url_noneu((int)$_GET['products_id']);
